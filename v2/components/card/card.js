...
export default class TclCard extends HTMLElement {
    ...
    return (this.checkDay &&
      (((this.charter || this.dok || (
        ...
        (((['NEW', 'ACC'].includes(this.STATUSCODE) &&
          ...
          (!this.hideCustoms &&
            (this.Action_From_QPAR === 'CHUB' || this.Action_From_QPAR === 'CHUB2' || this.Action_From_QPAR === 'CUNLOA' || this.Action_From_QPAR === 'CLOAD') &&
  ...
  get truck() {
    if (this._truck === undefined) {
      ...
      if (!this._truck && ['CHUB', 'CHUB2', 'CUNLOA', 'CLOAD'].includes(this.Action_From_QPAR) && this.Action_To_QPAR === 'TURNIN') {
